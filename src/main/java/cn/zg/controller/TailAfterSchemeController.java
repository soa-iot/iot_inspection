...
@RestController
@RequestMapping("/productionReport/tailAfterScheme")
public class TailAfterSchemeController {
	private static Logger logger = LoggerFactory.getLogger( PurificationSchemeService.class );
	
	@Autowired
	private TailAfterSchemeInter psi;
	...
	public ResultJson<List<Map<String,Object>>> getInspectionNames(String userId){
		logger.debug( "-C-------获取所有的方案信息-----------" );
		List<Map<String, Object>> lists = psi.getInspectioNames(userId);

<script type="text/javascript"  layType="onlyJs">
	...
	global[$($('script')[$('script').length-1]).parent().attr('id')] = text_content_one;
</script>
...
<script type="text/javascript" layType="onlyJs">	
	...
	$(function(){
		...
		console.log(global);
		//动态生成table的cols属性
		console.log(global[$(currentObj).parent().attr('id')].isShowOrder);
		if(global[$(currentObj).parent().attr('id')].isShowOrder == 'true'){
